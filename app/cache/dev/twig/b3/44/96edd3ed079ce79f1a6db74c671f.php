    ...
    <table>
        ...
        foreach ($context['_seq'] as $context['_key'] => $context['listener']) {
            ...
            echo "</code></td>
                <td><code>";
            // line 23
            echo twig_escape_filter($this->env, $this->getAttribute($context['__internal_b34496edd3ed079ce79f1a6db74c671f_1'], "display_listener", array($this->getContext($context, 'listener'), ), "method", false), "html");
            echo "</code></td>
            </tr>
        ";
        }
        ...
        <table>
            ...
            foreach ($context['_seq'] as $context['_key'] => $context['listener']) {
                ...
                echo "</code></td>
                    <td><code>";
                // line 40
                echo twig_escape_filter($this->env, $this->getAttribute($context['__internal_b34496edd3ed079ce79f1a6db74c671f_1'], "display_listener", array($this->getAttribute($this->getContext($context, 'listeners'), $this->getContext($context, 'listener'), array(), "array", false), ), "method", false), "html");
                echo "</code></td>
                </tr>
            ";
            }
