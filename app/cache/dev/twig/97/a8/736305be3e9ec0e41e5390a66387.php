...
class __TwigTemplate_97a8736305be3e9ec0e41e5390a66387 extends Twig_Template
{
    ...
    ";
        ...
        // line 9
        echo "            ";
        if (null !== $this->getAttribute($this->getAttribute($this->getContext($context, 'collector'), "controller", array(), "any", false), "class", array(), "any", true)) {
            // line 10
            echo "                <span>";
...
";
    ...
    ";
        ...
        ";
            // line 124
            $this->env->loadTemplate("WebProfilerBundle:Profiler:bag.html.twig")->display(array("bag" => $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, 'profiler'), "parenttoken", array(), "any", false), "get", array("request", ), "method", false), "requestattributes", array(), "any", false)));
            // line 125
            echo "    ";
        }
        // line 126
    ...
    ";
        ...
        ";
            ...
            ";
                // line 132
                $this->env->loadTemplate("WebProfilerBundle:Profiler:bag.html.twig")->display(array("bag" => $this->getAttribute($this->getAttribute($this->getContext($context, 'subrequest'), "get", array("request", ), "method", false), "requestattributes", array(), "any", false)));
                // line 133
                echo "        ";
            }
            $_parent = $context['_parent'];
