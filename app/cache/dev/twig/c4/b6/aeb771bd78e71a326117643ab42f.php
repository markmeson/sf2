...
class __TwigTemplate_c4b6aeb771bd78e71a326117643ab42f extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        $this->blocks = array(
            ...
            'csrf_widget' => array($this, 'block_csrf_widget'),
...
";
        // line 77
        $this->displayBlock('csrf_widget', $context, $blocks);
        // line 83
        echo "
";
        // line 84
...
";
    ...
    public function block_text_widget($context, array $blocks = array())
    {
        ...
        // line 61
        echo "    ";
        echo twig_escape_filter($this->env, $this->renderBlock("field_widget", $context, $blocks), "html");
        echo "
";
        echo trim(preg_replace('/>\s+</', '><', ob_get_clean()));
    }
...
";
    ...
    // line 77
    public function block_csrf_widget($context, array $blocks = array())
    {
        // line 78
        echo "    ";
        if (((!$this->getAttribute($this->getContext($context, 'form'), "hasParent", array(), "any", false)) || (!$this->getAttribute($this->getAttribute($this->getContext($context, 'form'), "getParent", array(), "any", false), "hasParent", array(), "any", false)))) {
            // line 79
            echo "        ";
            $context['type'] = ((twig_test_defined("type", $context)) ? (twig_default_filter($this->getContext($context, 'type'), "hidden")) : ("hidden"));
            // line 80
...
";
    ...
    public function block_date_widget($context, array $blocks = array())
    {
        ...
        // line 161
        echo "    ";
        if (($this->getContext($context, 'widget') == "text")) {
            // line 162
            echo "        ";
            echo twig_escape_filter($this->env, $this->renderBlock("text_widget", $context, $blocks), "html");
            echo "
    ";
        } else {
            // line 164
...
";
    ...
    public function block_collection_widget($context, array $blocks = array())
    {
        ...
        // line 230
        echo "    ";
        echo twig_escape_filter($this->env, $this->renderBlock("form_widget", $context, $blocks), "html");
        echo "
";
        echo trim(preg_replace('/>\s+</', '><', ob_get_clean()));
    }
    ...
    public function block_repeated_row($context, array $blocks = array())
    {
        ...
        // line 236
        echo "    ";
        echo twig_escape_filter($this->env, $this->renderBlock("field_rows", $context, $blocks), "html");
        echo "
";
        echo trim(preg_replace('/>\s+</', '><', ob_get_clean()));
    }
