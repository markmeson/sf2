...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Assetic\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeStoreBundle', '/var/www/Symfony/app/Resources/AcmeStoreBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeStoreBundle', '/var/www/Symfony/src/Acme/StoreBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Assetic\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FOSUserBundle', '/var/www/Symfony/app/Resources/FOSUserBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FOSUserBundle', '/var/www/Symfony/vendor/bundles/FOS/UserBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Assetic\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'WebProfilerBundle', '/var/www/Symfony/app/Resources/WebProfilerBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'WebProfilerBundle', '/var/www/Symfony/vendor/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Assetic\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SymfonyWebConfiguratorBundle', '/var/www/Symfony/app/Resources/SymfonyWebConfiguratorBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SymfonyWebConfiguratorBundle', '/var/www/Symfony/vendor/bundles/Symfony/Bundle/WebConfiguratorBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'symfony', 'host' => 'localhost', 'user' => 'root', 'password' => 'k0g4IT43', 'driver' => 'pdo_mysql', 'port' => NULL, 'driverOptions' => array()), $this->get('doctrine.dbal.default_connection.configuration'), $this->get('doctrine.dbal.default_connection.event_manager'));
    }
    ...
    protected function getDoctrine_Orm_DefaultConfigurationService()
    {
        ...
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, array(0 => '/var/www/Symfony/src/Acme/StudyBundle/Entity', 1 => '/var/www/Symfony/vendor/bundles/FOS/UserBundle/Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Acme\\StudyBundle\\Entity');
        ...
        $instance->setEntityNamespaces(array('AcmeStudyBundle' => 'Acme\\StudyBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity'));
        $instance->setMetadataCacheImpl($a);
        $instance->setQueryCacheImpl($b);
        $instance->setResultCacheImpl($c);
        $instance->setMetadataDriverImpl($f);
        $instance->setProxyDir('/var/www/Symfony/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file.temporary_storage'] = new \Symfony\Component\HttpFoundation\File\SessionBasedTemporaryStorage($this->get('session'), '88d40b7e910f589c10e5d1048508214b3b', '/var/www/Symfony/app/cache/dev/upload');
    }
    ...
    {
        return $this->services['form.factory'] = new \Symfony\Component\Form\FormFactory(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension($this, array('field' => 'form.type.field', 'form' => 'form.type.form', 'birthday' => 'form.type.birthday', 'checkbox' => 'form.type.checkbox', 'choice' => 'form.type.choice', 'collection' => 'form.type.collection', 'country' => 'form.type.country', 'date' => 'form.type.date', 'datetime' => 'form.type.datetime', 'email' => 'form.type.email', 'file' => 'form.type.file', 'hidden' => 'form.type.hidden', 'integer' => 'form.type.integer', 'language' => 'form.type.language', 'locale' => 'form.type.locale', 'money' => 'form.type.money', 'number' => 'form.type.number', 'password' => 'form.type.password', 'percent' => 'form.type.percent', 'radio' => 'form.type.radio', 'repeated' => 'form.type.repeated', 'textarea' => 'form.type.textarea', 'text' => 'form.type.text', 'time' => 'form.type.time', 'timezone' => 'form.type.timezone', 'url' => 'form.type.url', 'csrf' => 'form.type.csrf', 'entity' => 'form.type.entity', 'fos_user.form.type.user' => 'fos_user.form.type.user', 'fos_user.form.type.change_password' => 'fos_user.form.type.change_password', 'fos_user.form.type.reset_password' => 'fos_user.form.type.reset_password'), array('field' => array(0 => 'form.type_extension.field'), 'form' => array(0 => 'form.type_extension.csrf')), array(0 => 'form.type_guesser.validator', 1 => 'form.type_guesser.doctrine'))));
    }
    ...
    /**
     * Gets the 'fos_user.aces_installer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return FOS\UserBundle\Util\AcesInstaller A FOS\UserBundle\Util\AcesInstaller instance.
     */
    protected function getFosUser_AcesInstallerService()
    {
        return $this->services['fos_user.aces_installer'] = new \FOS\UserBundle\Util\AcesInstaller($this->get('fos_user.user_manager'), NULL);
    }
    ...
    {
        return $this->services['fos_user.form.change_password'] = $this->get('form.factory')->create($this->get('fos_user.form.type.change_password'), '', array('data_class' => 'FOS\\UserBundle\\Form\\ChangePassword', 'validation_groups' => array(0 => 'ChangePassword')));
    }

    /**
     * Gets the 'fos_user.form.handler.change_password' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return FOS\UserBundle\Form\ChangePasswordFormHandler A FOS\UserBundle\Form\ChangePasswordFormHandler instance.
     */
    protected function getFosUser_Form_Handler_ChangePasswordService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('fos_user.form.handler.change_password', 'request');
        }

        return $this->services['fos_user.form.handler.change_password'] = $this->scopedServices['request']['fos_user.form.handler.change_password'] = new \FOS\UserBundle\Form\ChangePasswordFormHandler($this->get('fos_user.form.change_password'), $this->get('request'), $this->get('fos_user.user_manager'));
    }

    /**
     * Gets the 'fos_user.form.handler.reset_password' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return FOS\UserBundle\Form\ResetPasswordFormHandler A FOS\UserBundle\Form\ResetPasswordFormHandler instance.
     */
    protected function getFosUser_Form_Handler_ResetPasswordService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('fos_user.form.handler.reset_password', 'request');
        }

        return $this->services['fos_user.form.handler.reset_password'] = $this->scopedServices['request']['fos_user.form.handler.reset_password'] = new \FOS\UserBundle\Form\ResetPasswordFormHandler($this->get('fos_user.form.reset_password'), $this->get('request'), $this->get('fos_user.user_manager'));
    }

    /**
     * Gets the 'fos_user.form.handler.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return FOS\UserBundle\Form\UserFormHandler A FOS\UserBundle\Form\UserFormHandler instance.
     */
    protected function getFosUser_Form_Handler_UserService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('fos_user.form.handler.user', 'request');
        }

        return $this->services['fos_user.form.handler.user'] = $this->scopedServices['request']['fos_user.form.handler.user'] = new \FOS\UserBundle\Form\UserFormHandler($this->get('fos_user.form.user'), $this->get('request'), $this->get('fos_user.user_manager'));
    }
    ...
    {
        return $this->services['fos_user.form.reset_password'] = $this->get('form.factory')->create($this->get('fos_user.form.type.reset_password'), '', array('data_class' => 'FOS\\UserBundle\\Form\\ResetPassword', 'validation_groups' => array(0 => 'ResetPassword')));
    }

    /**
     * Gets the 'fos_user.form.type.change_password' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return FOS\UserBundle\Form\ChangePasswordFormType A FOS\UserBundle\Form\ChangePasswordFormType instance.
     */
    protected function getFosUser_Form_Type_ChangePasswordService()
    {
        return $this->services['fos_user.form.type.change_password'] = new \FOS\UserBundle\Form\ChangePasswordFormType('fos_user_change_password_form', array('theme' => 'TwigBundle::form.html.twig'));
    }

    /**
     * Gets the 'fos_user.form.type.reset_password' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return FOS\UserBundle\Form\ResetPasswordFormType A FOS\UserBundle\Form\ResetPasswordFormType instance.
     */
    protected function getFosUser_Form_Type_ResetPasswordService()
    {
        return $this->services['fos_user.form.type.reset_password'] = new \FOS\UserBundle\Form\ResetPasswordFormType('fos_user_reset_password_form', array('theme' => 'TwigBundle::form.html.twig'));
    }

    /**
     * Gets the 'fos_user.form.type.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return FOS\UserBundle\Form\UserFormType A FOS\UserBundle\Form\UserFormType instance.
     */
    protected function getFosUser_Form_Type_UserService()
    {
        return $this->services['fos_user.form.type.user'] = new \FOS\UserBundle\Form\UserFormType('fos_user_user_form', array('theme' => 'TwigBundle::form.html.twig'));
    }
    ...
    {
        return $this->services['fos_user.form.user'] = $this->get('fos_user.form_builder.user')->getForm();
    }

    /**
     * Gets the 'fos_user.form_builder.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Symfony\Component\Form\FormBuilder A Symfony\Component\Form\FormBuilder instance.
     */
    protected function getFosUser_FormBuilder_UserService()
    {
        $this->services['fos_user.form_builder.user'] = $instance = $this->get('form.factory')->createBuilder($this->get('fos_user.form.type.user'), '', array('data_class' => 'Acme\\StudyBundle\\Entity\\User', 'validation_groups' => array(0 => 'Registration')));

        $instance->addEventSubscriber(new \FOS\UserBundle\Form\UpdateCanonicalFieldsListener($this->get('fos_user.user_manager')));
    ...
    /**
     * Gets the 'fos_user.user_activator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return FOS\UserBundle\Util\UserActivator A FOS\UserBundle\Util\UserActivator instance.
     */
    protected function getFosUser_UserActivatorService()
    {
        return $this->services['fos_user.user_activator'] = new \FOS\UserBundle\Util\UserActivator($this->get('fos_user.user_manager'));
    }

    /**
     * Gets the 'fos_user.user_creator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return FOS\UserBundle\Util\UserCreator A FOS\UserBundle\Util\UserCreator instance.
     */
    protected function getFosUser_UserCreatorService()
    {
        return $this->services['fos_user.user_creator'] = new \FOS\UserBundle\Util\UserCreator($this->get('fos_user.user_manager'), NULL);
    }

    /**
     * Gets the 'fos_user.user_deactivator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return FOS\UserBundle\Util\UserDeactivator A FOS\UserBundle\Util\UserDeactivator instance.
     */
    protected function getFosUser_UserDeactivatorService()
    {
        return $this->services['fos_user.user_deactivator'] = new \FOS\UserBundle\Util\UserDeactivator($this->get('fos_user.user_manager'));
    }

    /**
     * Gets the 'fos_user.user_demoter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return FOS\UserBundle\Util\UserDemoter A FOS\UserBundle\Util\UserDemoter instance.
     */
    protected function getFosUser_UserDemoterService()
    {
        return $this->services['fos_user.user_demoter'] = new \FOS\UserBundle\Util\UserDemoter($this->get('fos_user.user_manager'));
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Entity\UserManager($this->get('fos_user.encoder_factory'), 'sha512', $this->get('fos_user.util.username_canonicalizer'), $this->get('fos_user.util.email_canonicalizer'), $this->get('doctrine.orm.default_entity_manager'), 'Acme\\StudyBundle\\Entity\\User');
    }

    /**
     * Gets the 'fos_user.user_password_changer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return FOS\UserBundle\Util\UserPasswordChanger A FOS\UserBundle\Util\UserPasswordChanger instance.
     */
    protected function getFosUser_UserPasswordChangerService()
    {
        return $this->services['fos_user.user_password_changer'] = new \FOS\UserBundle\Util\UserPasswordChanger($this->get('fos_user.user_manager'));
    }

    /**
     * Gets the 'fos_user.user_promoter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return FOS\UserBundle\Util\UserPromoter A FOS\UserBundle\Util\UserPromoter instance.
     */
    protected function getFosUser_UserPromoterService()
    {
        return $this->services['fos_user.user_promoter'] = new \FOS\UserBundle\Util\UserPromoter($this->get('fos_user.user_manager'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/var/www/Symfony/app/logs/dev.log', 100, false);
    }
    ...
    {
        return $this->services['router.cached'] = new \Symfony\Bundle\FrameworkBundle\Routing\CachedRouter('/var/www/Symfony/app/cache/dev', 'appdevUrlMatcher', 'appdevUrlGenerator');
    }
    ...
    {
        return $this->services['router.real'] = new \Symfony\Component\Routing\Router(new \Symfony\Bundle\FrameworkBundle\Routing\LazyLoader($this, 'routing.loader.real'), '/var/www/Symfony/app/config/routing_dev.yml', array('cache_dir' => '/var/www/Symfony/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher'));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('.*'), 'security.firewall.map.context.profiler' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/_profiler'), 'security.firewall.map.context.wdt' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/_wdt'), 'security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/login$'), 'security.firewall.map.context.secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/'))), $this->get('event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $d = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, '/logout', '/', NULL);
        $d->addHandler($this->get('security.logout.handler.session'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_manager')), 'main', $b, $c), 2 => $d, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), 'main', array('check_path' => '/login_check', 'login_path' => '/login', 'use_forward' => false, 'failure_path' => NULL, 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false, 'failure_forward' => false, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_page_id' => 'form_login', 'post_only' => true), NULL, NULL, $b, $c), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '4dd06ec9cf829', $b), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($this->get('http_kernel'), '/login', false), NULL, NULL, $b));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_manager')), 'secured_area', $b, $c), 2 => $d, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), 'secured_area', array('check_path' => '/demo/secured/login_check', 'login_path' => '/demo/secured/login', 'use_forward' => false, 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false, 'failure_path' => NULL, 'failure_forward' => false, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_page_id' => 'form_login', 'post_only' => true), NULL, NULL, $b, $c), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($this->get('http_kernel'), '/demo/secured/login', false), NULL, NULL, $b));
    }
    ...
    {
        return $this->services['symfony.webconfigurator'] = new \Symfony\Bundle\WebConfiguratorBundle\Configurator('/var/www/Symfony/app');
    }
    ...
    {
        return $this->services['translator.real'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => 'php', 'translation.loader.yml' => 'yml', 'translation.loader.xliff' => 'xliff'), array('cache_dir' => '/var/www/Symfony/app/cache/dev/translations', 'debug' => true), $this->get('session'));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'cache' => '/var/www/Symfony/app/cache/dev/twig', 'charset' => 'UTF-8'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), '/var/www/Symfony/app/../web', true);
    ...
    {
        return $this->services['profiler.storage'] = new \Symfony\Component\HttpKernel\Profiler\SqliteProfilerStorage('sqlite:/var/www/Symfony/app/cache/dev/profiler.db', '', '', 86400);
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $b = $this->get('fos_user.encoder_factory');

        $c = new \Symfony\Component\Security\Core\User\UserChecker();

        return $this->services['security.authentication.manager'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $c, 'main', $b), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('4dd06ec9cf829'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $c, 'secured_area', $b)));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'fos_user.model.user.class' => 'Acme\\StudyBundle\\Entity\\User',
            'fos_user.form.type.user.class' => 'FOS\\UserBundle\\Form\\UserFormType',
            'fos_user.form.type.change_password.class' => 'FOS\\UserBundle\\Form\\ChangePasswordFormType',
            'fos_user.form.type.reset_password.class' => 'FOS\\UserBundle\\Form\\ResetPasswordFormType',
            'fos_user.form.handler.user.class' => 'FOS\\UserBundle\\Form\\UserFormHandler',
            'fos_user.form.handler.change_password.class' => 'FOS\\UserBundle\\Form\\ChangePasswordFormHandler',
            'fos_user.form.handler.reset_password.class' => 'FOS\\UserBundle\\Form\\ResetPasswordFormHandler',
